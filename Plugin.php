...
$fill="white";
		...
		if (Helper::options()->plugin('FlowChart')->importJquery) {
            echo '<script src="https://www.yigmx.com//usr/plugins/FlowChart/jquery.min.js"></script>';
        }
         echo <<<HTML
         
<script src="https://www.yigmx.com//usr/plugins/FlowChart/raphael.min.js"></script>
<script src="https://www.yigmx.com//usr/plugins/FlowChart/flowchart.min.js"></script>
<script>
        $(function () {
